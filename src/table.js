//sistema deve usar tailwindcss
//sistema deve ter um elemento html do tipo table, com id definido, preparado e sem informações dentro
// são necessários 2 arrays na tabela (array de dados e array com objetos que caracterizam as colunas)
...
function createTableHeader(tableReference, columnsArray) {
  ...
  ["bg-blue-800", "text-slate-200", "sticky", "top-0"].forEach((cssClass) =>
